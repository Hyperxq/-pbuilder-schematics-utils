...
const mainConfig = {
  ...
  plugins: [
    ...basePlugins,
    cleaner({ targets: ['../../dist/angular-utils'] }),
    copy({
      targets: [
        {
          src: 'package.json',
          dest: '../../dist/angular-utils',
          transform: (contents) => {
        ...
        { src: 'README.md', dest: '../../dist/angular-utils' },
        { src: 'src/collection.json', dest: '../../dist/angular-utils' },
        {
          src: 'src/**/*.json',
          dest: '../../dist/angular-utils',
